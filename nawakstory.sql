...
--
-- Hôte : 127.0.0.1
-- Généré le : sam. 21 mars 2020 à 16:40
...
(2, 'Les ruines de l\'incompréhension', 'Aucune description', 'images/ruines.jpg');
...
(10, 'test2', '60303ae22b998861bce3b28f33eec1be758a213c86c93c076dbe9f558c11c752', 5, 11, 8, 4, 10);
...
--
ALTER TABLE `aventurier`
  MODIFY `id_aventurier` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
